...
#' @description A dataset containing the information about individuals (three-spined sticklebacks) and chambers (Blazka-type, 250 mL) which were input manually in the function \code{\link{input.info}})
#' @usage info
