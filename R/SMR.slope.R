...
#' @description A dataset containing extracted slopes for further SMR calculations and other attributes of standard metabolic rate measurements obtained by using the function \code{\link{extract.slope}}
#' @usage SMR.slope
