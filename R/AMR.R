...
#' @description A dataset containing background respiration, absolute and mass-specific active metabolic rate data obtained by using the function \code{\link{calculate.MR}}
#' @usage AMR
...
#'   \item{MR.abs.with.BR}{Absolute AMR with background respiration (mgO2/h)}
